...
> Version : 2.1
> Statut : GDB et ACT (001-002) clos --- ACT-003 retiré, ACT-004 créé en Proposition --- autres bibliothèques à approfondir
> Type : Audit
> Maturité : 1
> Bibliothèque : AUDIT
...
| ACT (005 → 010), PATTERNS, VERBS | ◻️ Non créés --- rien à auditer tant qu'ils n'existent pas (voir ACT/CATALOG.md) |
